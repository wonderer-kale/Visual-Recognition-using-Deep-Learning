...
parser.add_argument('--de_type', nargs='+', default=['rain', 'snow'],
                    help='type of degradations is training and testing for.')
...
parser.add_argument("--wblogger", type=str, default="promptir",
                    help="Determine to log to wandb and the project name")
parser.add_argument("--ckpt_dir", type=str, default="train_ckpt",
                    help="Name of the Directory to save the checkpoint")
